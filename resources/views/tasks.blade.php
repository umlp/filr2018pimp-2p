...
@endif
  ...
  <div class="row subcontainer">
	...
	<div class="col-xs-3 colonne"> 
	  ...
	  <div class="row"><div class="dataLabel"> Identifiant : </div><div class="column input" style="flex:2"><input type="text" name="id" id="idInput" class="formInput" placeholder="votremail@exemple.com"/></div></div>
