...
<div class="container">
  ...
  <div class="row subcontainer">
	...
	<div class="col-xs-3 colonne"> 
	  <div class="row"><div class="dataLabel"> URL : </div><input type="text" name="url" id="urlInput" class="formInput" placeholder=""/></div>
	  <div class="row"><div class="dataLabel"> Identifiant : </div><input type="text" name="id" id="idInput" class="formInput" placeholder="votremail@exemple.com"/></div>
	  <div class="row"><div class="dataLabel"> Mot de passe : </div><input type="password" name="password" id="passwordInput" class="formInput" placeholder="Votre mot de passe"/></div>
	</div>
